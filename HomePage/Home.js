...
BackgroundResult += 'conic-gradient(from var(--bg-angle), ';
...
var Angle = 360;
var AngleMultiplier = 4;
var MaxAngle = Angle * AngleMultiplier;
var Increment = 180;

var Colors = [Color2, Color1, Color3, Color1];

for(var i = 0; i < AngleMultiplier; i++){
    if(i != 0) BackgroundResult += ',';

    var CurrentAngleValue = Angle * i / AngleMultiplier;
    var NextAngleValue = CurrentAngleValue + Angle / AngleMultiplier;

    BackgroundResult += Colors[i % Colors.length] + CurrentAngleValue + 'deg,';
    BackgroundResult += Colors[i % Colors.length] + NextAngleValue + 'deg';
}

BackgroundResult += ') border-box';
//alert(BackgroundResult);
